# BlockUp Puzzle - PM 套件完整产出

基于 [BlockUp Puzzle](https://503882514-prog.github.io/Blockup-Puzzle/) 游戏，使用 PM 套件 V1.0 生成的完整产品文档。
...
BlockUp Puzzle 是一款面向休闲玩家的 H5 方块放置消除游戏，核心特性包括：

- 8x8 棋盘 + 37 种方块形状
- 行列消除 + 连击倍数系统
- 三种策略道具：炸弹 / 重力 / 刷新
- 金币经济 + 复活机制
- 纯前端，无需后端，支持 PWA 离线游玩

## 技术栈

- 原型基于单文件 HTML + Tailwind CDN + 原生 JavaScript
